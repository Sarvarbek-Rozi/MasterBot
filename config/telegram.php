...
return [
    'ng_domain' => env('NG_DOMAIN', 'https://778e-195-158-16-9.ngrok-free.app'),
    'admin_username' => env('TELEGRAM_ADMIN_USERNAME', 'Bilimdon_admini'),
    ...
    */
    'bots'                         => [
        'mybot' => [
            ...
            'token'               => env('TELEGRAM_BOT_TOKEN', '7021861839:AAGIsWOEJu6-B4r4MBAHvRaLgPnHxPR1huE'),
